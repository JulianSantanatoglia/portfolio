...
const Introduction = () => {
  ...
  Si tienes una idea,<br className="md:block" />
  podemos
  ...
  />
          ...
          <Experience />
          <p className="mx-auto mb-4 text-base md:mx-0 md:mb-10 lg:text-xl px-4 sm:px-0 text-center sm:text-left">
            ¡Hola! Soy Julián, Desarrollador web Frontend con experiencia en
            diseño. Construyo sitios web modernos y funcionales, enfocados en la
